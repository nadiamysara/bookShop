...
class GenresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create genre" do
    assert_difference("Genre.count") do
      post genres_url, params: { genre: { category: @genre.category, description: @genre.description } }
    end
  ...
  test "should update genre" do
    patch genre_url(@genre), params: { genre: { category: @genre.category, description: @genre.description } }
