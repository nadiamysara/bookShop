...
class RentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rent" do
    assert_difference("Rent.count") do
      post rents_url, params: { rent: { book: @rent.book, dateBorrowed: @rent.dateBorrowed, dateDue: @rent.dateDue, user: @rent.user } }
    end
  ...
  test "should update rent" do
    patch rent_url(@rent), params: { rent: { book: @rent.book, dateBorrowed: @rent.dateBorrowed, dateDue: @rent.dateDue, user: @rent.user } }
