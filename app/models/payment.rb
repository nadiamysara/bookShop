class Payment < ApplicationRecord
  ...
  def g_checksum
    string = "#{buyer_email}|#{buyer_name}|#{buyer_phone}||#{order_number}|#{product_description}|http://159.65.1.41:3000/payments/#{id}/redirect|#{transaction_amount}|96111c67-91fc-43dd-b3fa-ad2e3a323753"
